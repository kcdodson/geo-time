...
export default function Sidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 h-full w-16 md:w-60 flex flex-col z-40"
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-5" style={{ borderBottom: "1px solid var(--color-border)" }}>
        <div className="flex-shrink-0 flex items-center justify-center w-9 h-9 rounded-lg"
          style={{ background: "var(--color-amber)", boxShadow: "0 0 20px rgba(245,158,11,0.3)" }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" /><polyline points="12,6 12,12 16,14" />
          </svg>
        </div>
        <span className="hidden md:block text-white font-bold text-lg" style={{ fontFamily: "var(--font-heading)" }}>
          GeoTime
        </span>
      </div>
      ...
      {/* Sign out */}
      <div className="px-2 pb-4" style={{ borderTop: "1px solid var(--color-border)", paddingTop: "1rem" }}>
        <button
